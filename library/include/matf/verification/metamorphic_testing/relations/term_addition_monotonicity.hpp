...
class TermAdditionMonotonicity : public MetamorphicRelation {
public:
    explicit TermAdditionMonotonicity(TokenGenerator& token_generator) : MetamorphicRelation(token_generator) {}
    ...
    constexpr std::string get_name() const override {
        return "term_addition_monotonicity";
    }
};
} // namespace matf::verification::metamorphic_testing::relations
